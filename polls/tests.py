...
class IndexViewTests(TestCase):
    ...
    def test_future_and_past_questions(self):
        ...
        self._create_question(past_question_text, days=-1)
        self._create_question('Future question', days=7)
        response = self.client.get(reverse('polls:index'))
    ...
    def test_past_questions_order(self):
        ...
        self._create_question(old_question_text, days=-7)
        recent_question_text = 'Recent question'
        self._create_question(recent_question_text, days=-1)
        response = self.client.get(reverse('polls:index'))
        self.assertQuerysetEqual(response.context['latest_question_list'],
